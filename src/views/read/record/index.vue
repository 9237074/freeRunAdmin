<template>
  <d2-container>
    ...
    <el-table :data="tableData" stripe style="height: 550px">
      ...
      <el-table-column prop="readTime" label="晨读时间" width="100">
      </el-table-column>
      <el-table-column prop="readDate" label="晨读日期" width="260">
      </el-table-column>
      <el-table-column prop="readsite" label="晨读地点" width="90">
      </el-table-column>
      <el-table-column prop="theme" label="主题" width="90"> </el-table-column>
      <el-table-column prop="date" label="签到日期" width="100">
      </el-table-column>
      <el-table-column prop="peopleId" label="负责人" width="100">
      </el-table-column>
...
<script>
import getReadRecord from '@api/read/record';
export default {
  name: 'record',
  data () {
    return {
