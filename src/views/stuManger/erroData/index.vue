<template>
  <d2-container>
    <el-table :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="grade" label="年级" width="75"> </el-table-column>
      <el-table-column prop="Department" label="院系" width="130">
      </el-table-column>
      <el-table-column prop="profession" label="行政班级" width="130">
      </el-table-column>
    </el-table>
    <div style="margin-top: 20px">
      <span class="text">每页10条数据，共9999条</span>
      <span class="page">
...
<script>
import { errData } from '@api/admin/errData'
export default {
  name: 'erroData',
  data () {
    return {
