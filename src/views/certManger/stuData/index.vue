<template>
  ...
  <el-menu-item index="2">2019级</el-menu-item>
  <el-menu-item index="3" >2018级</el-menu-item>
  <el-menu-item index="4">2017级</el-menu-item>
        <el-menu-item index="5">2016级</el-menu-item>
</el-menu>
<div class="line"></div>
    <el-table
    :data="tableData"
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)">已认证名单</el-button>
        <el-button
          size="mini"
          type="danger"
          @click="handleDelete(scope.$index, scope.row)">未认证名单</el-button>
      </template>
    </el-table-column>
